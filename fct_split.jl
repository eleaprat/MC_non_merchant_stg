...
function split(∆t, E, E_0, G_df, L_df, E_end, S_end)
    ...
    for mi in 1:nb_MI # For each market interval
        # Data as arrays
        C, P, U, D = data_all(G_df, G, L_df, L, T, mi)

        # Market clearing
        SW, λ, d, p, p_C, e, surplus_gen, surplus_load, surplus_stg = market_clearing_all(T, L, G, U, D, C, P, E, E_start, E_end[mi], S_end[mi], nb_t, ∆t)
